class Scatterplot {
    ...
    updateVis() {
      ...
      vis.config.height = vis.config.containerHeight - vis.config.margin.top - vis.config.margin.bottom; // subtract top and bottom margins
     
      // Update SVG Size 
      vis.svg.attr('width', vis.config.width)
      .attr('height', vis.config.height); // use vis. to access
